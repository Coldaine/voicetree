...
> **Note:** Numbers below (#5-#14) are internal roadmap IDs from `TODO.md`, not live GitHub issue numbers.

Priority order: Stability (#5-6) > Always-On (#7-8) > Scale (#9-10) > Visual (#11-12) > Foundation (#13-14)
